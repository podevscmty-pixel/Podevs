...
const issues = [
  { date: "MAY 01, 2025", tag: "Issue #42", title: "PODEVS Launches BuildFast Hackathon", excerpt: "We're thrilled to announce our biggest community event yet. BuildFast is a 24-hour hackathon open to all students — solo or in teams of up to 4." },
  { date: "APR 22, 2025", tag: "Issue #41", title: "The 30-Day Web Dev Challenge", excerpt: "A structured 30-day roadmap to go from zero to deployed portfolio. Includes daily tasks, tools, and links to our YouTube videos." },
  { date: "APR 10, 2025", tag: "Issue #40", title: "5 Open Source Projects Hiring Students", excerpt: "Great news for freshers — these beginner-friendly open source projects are actively looking for contributors and offering mentorship." },
  { date: "MAR 30, 2025", tag: "Issue #39", title: "Git Masterclass Recap & Resources", excerpt: "Summary of our biggest workshop yet — key takeaways, resources shared, and what participants said about the session." },
];
            ...
            <div className="card group cursor-pointer" style={{ padding: 0, overflow: "hidden", display: "flex", flexDirection: "column", border: "1px solid var(--orange)" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 20, padding: "40px md:padding: 56px", flex: 1 }} className="p-8 md:p-14">
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <span style={{ fontSize: "0.85rem", color: "var(--muted)", fontWeight: 600, display: "flex", alignItems: "center", gap: 6 }}><Calendar size={14} /> MAY 15, 2025</span>
                </div>
                ...
                <div>
                  <h2 style={{ fontSize: "clamp(1.8rem, 4vw, 2.8rem)", fontWeight: 800, lineHeight: 1.2, marginBottom: 16, color: "var(--text)" }} className="group-hover:text-[var(--orange)] transition-colors">
                    How to Structure a Production-Ready Next.js App
                  </h2>
                  <p style={{ color: "var(--muted)", fontSize: "1.1rem", lineHeight: 1.7, maxWidth: 800 }}>
                    In this issue, we break down the exact folder structure, state management patterns, and deployment strategies we use for scale. Plus, a new opportunity for contributors.
                  </p>
                </div>
                
                <div style={{ marginTop: 12 }}>
                  <Link href="#" style={{ display: "inline-flex", alignItems: "center", gap: 8, fontSize: "0.95rem", fontWeight: 700, color: "var(--orange)" }} className="hover:gap-3 transition-all">
      ...
      <section style={{ padding: "0 0 80px" }}>
        <div style={{ maxWidth: "var(--container)", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: 20 }}>
            {issues.map((issue, i) => (
              <Reveal key={issue.title} delay={0.1 + (i * 0.05)}>
                <Link href="#" className="card group" style={{ display: "block", padding: "32px", height: "100%", textDecoration: "none", transition: "all 0.3s ease" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                    ...
                    <span style={{ fontSize: "0.75rem", color: "var(--subtle)", fontWeight: 600 }}>{issue.date}</span>
                  </div>
